        ...
        if type(result_json) == list:
            if single:
                ...
                for i in result_json:
                    ...
                    single_user["id"] = i["id"]
                    single_user["contributions"] = i["contributions"]
                    single_user["company"] = "null"
            ...
            single_user_info_dict["contributions"] = result_json["contributions"]
            single_user_info_dict["company"] = "null"
